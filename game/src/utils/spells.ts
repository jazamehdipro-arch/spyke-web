...
export const SPELL_CATALOG: Record<SpellId, Spell> = {
  // Salamandre (ignis)
  frappe_ardente:    { id: 'frappe_ardente',    name: 'Frappe ardente',   emoji: '🔥',   energyCost: 1, cooldown: 0, description: '9 dégâts + 1 braise' },
  ...
  immolation:        { id: 'immolation',         name: 'Immolation',       emoji: '🩸',   energyCost: 2, cooldown: 0, description: '-8 PV sur soi → 15 dégâts garantis' },
  ...
  siphon:            { id: 'siphon',             name: 'Siphon',           emoji: '💧',   energyCost: 1, cooldown: 2, description: '5 dégâts + vole 2 énergie ennemie' },
  ...
  raz_de_maree:      { id: 'raz_de_maree',       name: 'Raz-de-marée',     emoji: '🌊💥', energyCost: 3, cooldown: 0, description: '19 dégâts + vol 2 énergie' },

  // Panda (sylva)
  coup_voile:        { id: 'coup_voile',         name: 'Coup voilé',       emoji: '👊',   energyCost: 1, cooldown: 0, description: '7 dégâts + 20% brouillage ennemi' },
  ...
  // Faon (zapp)
  decharge:          { id: 'decharge',           name: 'Décharge',         emoji: '⚡',   energyCost: 1, cooldown: 0, description: '8 dégâts rapides — priorité' },
