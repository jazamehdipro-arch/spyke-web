...
const s = StyleSheet.create({
  ...
  lockLevel: { fontSize: 11, color: retro.muted, fontWeight: '700', fontFamily: 'monospace', textAlign: 'center' },
  doneCheck: { fontSize: 22, color: retro.mint },
  ...
  beatenBadge: {
    ...
    backgroundColor: retro.paper2,
    borderWidth: 2,
    borderColor: retro.mint,
    alignItems: 'center',
    justifyContent: 'center',
  },
  beatenText: { color: retro.mint, fontWeight: '900', fontSize: 14, fontFamily: 'monospace' },
  opLock: { fontSize: 18 },
