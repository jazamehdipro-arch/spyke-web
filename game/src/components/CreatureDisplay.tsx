...
const SPRITES: Record<string, ImageSourcePropType> = {
  ...
  ignis_f0: require('../../assets/sprites/ignis_e1_clean.png'),
  ignis_f1: require('../../assets/sprites/ignis_e1_clean.png'),
  ignis_f2: require('../../assets/sprites/ignis_e1_clean.png'),
  ignis_f3: require('../../assets/sprites/ignis_e1_clean.png'),
  ignis_f4: require('../../assets/sprites/ignis_e1_clean.png'),
  ignis_f5: require('../../assets/sprites/ignis_e1_clean.png'),
  nemo_f0:  require('../../assets/sprites/nemo_e1_clean.png'),
  nemo_f1:  require('../../assets/sprites/nemo_e1_clean.png'),
  nemo_f2:  require('../../assets/sprites/nemo_e1_clean.png'),
  nemo_f3:  require('../../assets/sprites/nemo_e1_clean.png'),
  nemo_f4:  require('../../assets/sprites/nemo_e1_clean.png'),
  nemo_f5:  require('../../assets/sprites/nemo_e1_clean.png'),
  sylva_f0: require('../../assets/sprites/sylva_e1_clean.png'),
  sylva_f1: require('../../assets/sprites/sylva_e1_clean.png'),
  sylva_f2: require('../../assets/sprites/sylva_e1_clean.png'),
  sylva_f3: require('../../assets/sprites/sylva_e1_clean.png'),
  sylva_f4: require('../../assets/sprites/sylva_e1_clean.png'),
  sylva_f5: require('../../assets/sprites/sylva_e1_clean.png'),
  zapp_f0:  require('../../assets/sprites/zapp_e1_clean.png'),
  zapp_f1:  require('../../assets/sprites/zapp_e1_clean.png'),
  zapp_f2:  require('../../assets/sprites/zapp_e1_clean.png'),
  zapp_f3:  require('../../assets/sprites/zapp_e1_clean.png'),
  zapp_f4:  require('../../assets/sprites/zapp_e1_clean.png'),
  zapp_f5:  require('../../assets/sprites/zapp_e1_clean.png'),
